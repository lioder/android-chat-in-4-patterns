...
@Log
public class Hw2ViewModel extends BaseObservable implements MessageListener {
    ...
    public void setMsgNotDisplayed(int msgNotDisplayed) {
        this.msgNotDisplayed = msgNotDisplayed;
        notifyPropertyChanged(BR.msgNotDisplayed);
    }

    public Hw2ViewModel(UiOperator uiOperator) {
